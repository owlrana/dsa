/*
    ...
    Solving this problem RECRUSIVELY:

    1. Have two ptrs 'a' and 'b' pointed to lists. Another ptr 'c' which stores resulting list.
    2. Compare which one of them is smaller.
    3. Point the pointer c to the smaller part of it.
    4. Shift the head of used linked list to the next one.
    5. Do the same steps for remaining elements of the lists.
