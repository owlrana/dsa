...
int main ()
{
    ...
    // but the problem now that comes is:
    // cout << head << head2; // this won't work as "cout << head" returns VOID
    // thus we need to find out a way to return cout...
    // this effect is known as "CASCADING OF OPERATORS"
    // it is solved by returning "os" in our operator<< function
