/*
    We are going to do 2 things in this code:
    1.  Detecting if a linked list has cycles or not
    2.  finding the element where the linked list contains cycle from
*/
...
// find out if a linked list has loop or not
...
// find the point where the linked list contains cycle from
