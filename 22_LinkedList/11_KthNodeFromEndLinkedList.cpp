/*
    Finding Kth node from the end of a linked list

    1.  Traverse till the end, find the length of the list
        Go back k times and return

    2.  Go K ahead in the linked list from head. Call this pointer FRONT.
        Now assign another pointer BEHIND on head, and traverse both till
        FRONT reaches the end. The BEHIND pointer is now automatically at len-k
